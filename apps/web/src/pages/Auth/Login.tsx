...
import { ArrowLeft, Mail, Lock, AlertCircle, Brain, Shield, Sparkles } from 'lucide-react';
            ...
            <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center px-12">
                ...
                >
                    ...
                    <p className="text-xl text-purple-200 mb-12 leading-relaxed">
                        Welcome back! Your personalized career roadmap is waiting. Let's keep building your future together.
                    </p>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-start gap-3 glass rounded-2xl p-4">
                            ...
                            <div>
                                <div className="font-semibold text-white mb-1">Your Data is Safe</div>
                                <div className="text-sm text-purple-200">Bank-level encryption protects your information</div>
                            </div>
                        </div>
                        <div className="flex items-start gap-3 glass rounded-2xl p-4">
                            ...
                            <div>
                                <div className="font-semibold text-white mb-1">AI-Powered Insights</div>
                                <div className="text-sm text-purple-200">Get personalized recommendations tailored to your goals</div>
                            </div>
                        </div>
                    </div>
                </motion.div>
                ...
                >
                    <div className="card-glass p-8 md:p-10">
                        ...
                        <form className="space-y-6" onSubmit={handleSubmit}>
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="flex justify-end">
                                        <Link to="/auth/forgot-password" className="text-sm font-medium text-blue-400 hover:text-blue-300 transition-colors">
                                            Forgot password?
                                        </Link>
                                    </div>
                                </div>
                            ...
                            >
                                ...
                                {isGoogleLoading ? 'Signing in...' : !isFirebaseConfigured() ? 'Google sign-in (not configured)' : 'Continue with Google'}
                            </Button>
                        </form>      <div className="text-center text-sm">
                            <span className="text-purple-300">Don't have an account? </span>
                            <Link to="/auth/register" className="font-semibold text-blue-400 hover:text-blue-300 transition-colors">
                                Sign up for free
                            </Link>
                        </div>
                    ...
                    <div className="lg:hidden mt-8 space-y-3">
                        <div className="flex items-center gap-3 glass rounded-xl p-3 text-sm">
                            ...
                            <span className="text-purple-200">Your data is protected with bank-level security</span>
                        </div>
                    </div>
                </motion.div>
            </div>
